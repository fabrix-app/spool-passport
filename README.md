...
### Routes prefix
By default auth routes doesn't have prefix, but if you use `spool-tapestries` it automatically use tapestries prefix to match your API. You can change this prefix by setting `config.passport.prefix`.
